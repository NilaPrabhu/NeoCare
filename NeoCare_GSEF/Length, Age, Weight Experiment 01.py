...
benchmark_image_path = 'growth_chart_emphasized_overlay.png'
...
overlay_image_path = 'growth_chart_overlay.png'
...
full_width_highlighted_overlay_image_path = 'growth_chart_full_width_highlighted_overlay.png'
