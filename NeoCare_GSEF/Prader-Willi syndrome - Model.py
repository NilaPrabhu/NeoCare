...
file_male = 'Male Babibes - Data Table of Infant Weight-for-age Charts.csv'
file_female = 'Female Babibes - Data Table of Infant Weight-for-age Charts.csv'
...
img = mpimg.imread('Prader-Willi syndrome Baseline Graph.png')
